   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" id="phone" name="number" pattern="[0-9]{10}"class="box" required placeholder="enter your number" required> 
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>pin code :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 123456" class="box"  pattern="[0-9]{6}" required>>
         </div>
      </div>
